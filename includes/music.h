...
double notes_zense[SONG_LENGTH] = {0, };
unsigned char timing_zense[SONG_LENGTH] = {20,};
unsigned char rests_zense[SONG_LENGTH] = {20,};
unsigned char hit_zense[SONG_LENGTH] = {20, };
