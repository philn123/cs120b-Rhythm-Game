...
//Current Length : 10
double notes_zense[SONG_LENGTH] =           {0, B3, CS4, DS4, B4, FS4, CS5, FS4, DS5, FS5, B4};
unsigned char timing_zense[SONG_LENGTH] =   {20, 2,  2,  2,    2,   2,   2,   2,   2,   4,  2};
unsigned char rests_zense[SONG_LENGTH] =    {20, 0,  0,  2,    2,   2,   2,   2,   2,   4,  2};
unsigned char hit_zense[SONG_LENGTH] =      {20, 8,  4,  2,    1,   2,   1,   8,   2,   4,  8};
